...
def porcys():
    results = get_porcys_review_url()
    main_window = Tk()
    main_window.title("Latest Porcys reviews")
    ...
    for i in range(0, 8):
        ...
        artist_and_album = Label(font=("OpenSansRegularItalic", 12, "bold"),
                                 text=get_artist.text + '- ' + get_album.text,
                                 cursor="hand2")
        ...
        # date to label
        date_label = Label(font=("OpenSansRegular", 8), fg='#939598', text=date)
